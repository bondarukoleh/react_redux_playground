...
export class User extends Component {
  ...
  showLoginForm = () => {
    return (
      <div>
        <p>Hi Unknown user, to get your repos please login:</p>
  ...
  showUserForm = () => {
    ...
    return (
      <div>
        ...
        <img alt="git_hub_avatart" src={user.avatar_url} />
      </div>
    );
  };
  ...
  render() {
    ...
    return (
      <div>
        ...
        {!gitUser && userError && <p>Sorry we have an error. {userError.errorMessage}</p>}
      </div>
    );
  }
}
